<script>
    ...
    function handleClick() {
        document.querySelector('.signUpOfferBar').remove()
    };

    onDestroy(handleClick);
</script>

<div class="signUpOfferBar">
    <p>
        Sign up and get 20% off to tour first order. 
        <a href="#home"><strong>Sign Up Now</strong></a>
    </p>

    <button on:click={handleClick} class="closeBtn">
